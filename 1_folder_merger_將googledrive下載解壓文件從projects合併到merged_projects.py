...
"""
項目資料夾合併工具
合併 projects/ 目錄下的所有子資料夾到一個新的目標資料夾
支援深度遞迴合併，同名檔案採用覆蓋策略
"""
...
class ProjectMerger:
    ...
    def __init__(self, source_dir: str = "projects", target_dir: str = "merged_projects"):
        """
        初始化合併器
        
        Args:
            source_dir: 來源目錄路徑（預設: "projects"）
            target_dir: 目標目錄路徑（預設: "merged_projects"）
        """
...
def main():
    """主函數"""
    # 設定來源和目標目錄
    SOURCE_DIR = "projects"  # 可以修改為您的實際路徑
    TARGET_DIR = "merged_projects"  # 可以修改為您希望的目標路徑
