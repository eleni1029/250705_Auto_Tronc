...
class ScormPackager:
    ...
    def __init__(self, source_dir: str, output_dir: str = "03_scorm_packages"):
        """
        初始化打包器
        
        Args:
            source_dir: 來源目錄路徑
            output_dir: 輸出目錄路徑（預設: "03_scorm_packages"）
        """
    ...
    def _setup_logging(self):
        ...
        # 確保 output_dir 資料夾存在（這裡 output_dir 是 03_scorm_packages）
